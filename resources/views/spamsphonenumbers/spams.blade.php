...
@endif
            <div class="page-title">
                ...
                <div class="pull-left">
                    <h1 class="title">Spam Phone Numbers</h1>

                    <a href="{{ route('addspam') }}" class="btn btn-primary"> <i class="fa fa-plus"></i> Add Spam</a>
                 </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <td>{{ $s->phone_number }}</td>
                                             <td>{{ $s->score }}</td>
                                            <td><a href="{{ route('editSpam',['id' => $s->spam_id]) }}"><i class="fa fa-pencil"></i></a> | <a href="{{ route('deleteSpam',['id' => $s->spam_id]) }}"><i style="color:red;" class="fa fa-trash"></i></a></td>
